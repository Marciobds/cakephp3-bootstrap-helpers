...
class FormHelper extends \Cake\View\Helper\FormHelper {
    ...
    protected $_defaultConfig = [
        ...
        'templates' => [
            ...
            'radioContainer' => '<div class="form-group has-feedback">{{content}}</div>',
            ...
            'submitContainer' => '<div class="form-group has-feedback">{{submitContainerHorizontalStart}}{{content}}{{submitContainerHorizontalEnd}}</div>',
